...
const RealmMilitaryBuildCard = ({ building, showDialog, setIsBusy }: Props) => {
  ...
  const { contract: stakingContract } = useContract(STACKING_MILITARY_CONTRACT_ADDRESS);
...
export default RealmMilitaryBuildCard;
